...
namespace Opgave_5_grundlægende_simuleret_virksomhed
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (kører)
            {
                Console.WriteLine("Velkommen til Virksomhed A/S");
                Console.WriteLine("Afdelinger: HR, Lager, Economy"); //C# kan ikke arbejde med Ø
                Console.WriteLine("Login : "); //indtast afdelings navn f.eks. HR eller Lager eller Economy
